...
# May 2017
# Handling and manuevering our modified self-driving car.
...
def setup():
    """Setting up the car for driving"""
    waiting = True      # Signals that it is waiting for calibration
    orange = 18         # PIN number for the orange LED
    green = 22          # PIN number for the green LED
    temp = Asdf()
    temp.addMe(0)
...
def wheelCheck():
    """RUN BEFORE MAIN TO CHECK CIRCUITRY"""
